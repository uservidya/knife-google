...
This plugin depends on the gcutil CLI utility available at: https://developers.google.com/compute/docs/gcutil
...
Alternatively, the rake utility installs the latest gcutil CLI utility as part of installation
